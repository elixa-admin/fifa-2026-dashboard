...
export const TEAMS: Record<string, Team> = {
  ...
  ENG: {
    ...
    tournamentOdds: 10.0,
    fact: "England reached the EURO 2024 final for the second consecutive time, losing on penalties. 60 years of hurt may finally end under Gareth Southgate with the most complete England squad ever.",
    quote: "Football's coming home. It has to come home eventually.",
    quoteSource: "Gareth Southgate, England Head Coach",
